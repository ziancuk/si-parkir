        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Parkir Masuk Karyawan</h6>
                </div>
                            ...
                            <div class="card-group">
                                <div class="col-lg-6">
                                    <div class="card" style="height: 28rem;">
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Scan Kendaraan Masuk</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="container">
                                                <div class="row justify-content-center align-items-center" id="kamera" style="height: 100%; min-height: 100%;">
                                                    <div id="reader" style="width:600px !important"></div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <form action="/post/masuk" method="POST">
                                                        @csrf
                                                        <input type="hidden" class="mt-4" id="result"></input>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="container">
                                                <div id="park" class="row" style="margin-top:50px">
                                                    ...
                                                    <div class="col-lg text-center" style="margin-top:90px;">
                                                        <h3>SILAHKAN SCAN QR CODE UNTUK MASUK PARKIR</h3>
                                                    </div>
                                                    @endif
                                                </div>
                                            </div>
...
<script>
    function onScanSuccess(decodedText, decodedResult) {
        ...
        fetch('/post/masuk', {
            ...
            .catch(error => {
                ...
                h3.appendChild(document.createTextNode("SILAHKAN SCAN QR CODE UNTUK MASUK PARKIR"))
    ...
    function creteElementParking(res) {
        ...
        var text = [
            "Nomor Polisi", ": " + res.masuk.no_polisi,
            "NIK Karyawan", ": " + res.masuk.employee.nik_karyawan,
            "Nama Karyawan", ": " + res.masuk.employee.nama_karyawan,
            "Departemen", ": " + res.masuk.employee.departemen,
            "Blok", ": " + res.lok.nama_blok
        ]
